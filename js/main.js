...
var GameState = {
    ...
    switchAnimal: function (sprite, event) {
        ...
        game.add.tween(newAnimal).to( { alpha: 1 }, 1000, "Linear", true);
        ...
        newAnimalMovement.onUpdateCallback(function(){
            console.log("newAnimalMovement.onUpdateCallback");
        }, this);

        game.add.tween(this.currentAnimal).to( { alpha: 0.1 }, 1000, "Linear", true);
